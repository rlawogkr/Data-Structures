...
*/
void alternateMergeLinkedList(LinkedList *ll1, LinkedList *ll2)//1번과 2번을 번갈아가면서 1에 넣어주고, 2는 값을 없앰. 첫번째는 1먼저. findNode로 찾아서 넣어주고, removeNode로 없애줌.
{
	...
	{
		temp1 = findNode(ll1, i);
		temp2 = findNode(ll2, 0);
		
		insertNode(ll1, i+1, temp2->item);
		removeNode(ll2, 0);
